...
ykine_scrp_ik_pure      (void)
{
   ...
   for (x_leg = 0; x_leg < YKINE_MAX_LEGS; ++x_leg) {
      ...
      /*---(add moves)-------------------*/
      /*> rc = ykine_move_create (YKINE_MOVE_SERVO, g_servo_info + i + 0, myKINE.s_verb, myKINE.s_cline, myKINE.s_femu, myKINE.s_secs);   <* 
       *> rc = ykine_move_create (YKINE_MOVE_SERVO, g_servo_info + i + 1, myKINE.s_verb, myKINE.s_cline, myKINE.s_pate, myKINE.s_secs);   <* 
       *> rc = ykine_move_create (YKINE_MOVE_SERVO, g_servo_info + i + 2, myKINE.s_verb, myKINE.s_cline, myKINE.s_tibi, myKINE.s_secs);   <* 
      ...
      rc = ykine_move_create (YKINE_MOVE_SERVO, x_servo, myKINE.s_verb, myKINE.s_cline, myKINE.s_femu, myKINE.s_secs);
      /*---(add patella)-----------------*/
      x_servo = ykine_servo_pointer (x_leg, YKINE_PATE);
      if (x_servo ==  NULL)  continue;
      rc = ykine_move_create (YKINE_MOVE_SERVO, x_servo, myKINE.s_verb, myKINE.s_cline, myKINE.s_pate, myKINE.s_secs);
      /*---(add tibia)-------------------*/
      x_servo = ykine_servo_pointer (x_leg, YKINE_TIBI);
      if (x_servo ==  NULL)  continue;
      rc = ykine_move_create (YKINE_MOVE_SERVO, x_servo, myKINE.s_verb, myKINE.s_cline, myKINE.s_tibi, myKINE.s_secs);
      /*---(add endpoint)----------------*/
...
ykine_scrp_ik_from      (void)
{
   ...
   for (j = 0; j < g_nservo; ++j) {
      ...
      DEBUG_YKINE_SCRP  yLOG_double  ("pate deg"  , myKINE.s_pate);
      DEBUG_YKINE_SCRP  yLOG_double  ("tibi deg"  , myKINE.s_tibi);
      rc = ykine_move_create (YKINE_MOVE_SERVO, g_servo_info + j + 0, myKINE.s_verb, myKINE.s_cline, myKINE.s_femu, myKINE.s_secs);
      rc = ykine_move_create (YKINE_MOVE_SERVO, g_servo_info + j + 1, myKINE.s_verb, myKINE.s_cline, myKINE.s_pate, myKINE.s_secs);
      rc = ykine_move_create (YKINE_MOVE_SERVO, g_servo_info + j + 2, myKINE.s_verb, myKINE.s_cline, myKINE.s_tibi, myKINE.s_secs);
