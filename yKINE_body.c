...
char   ykine_body_zero         (void) { return ykine_legs_driver (YKINE_ZE); }
char   ykine_body_polar        (void) { return ykine_legs_driver (YKINE_PO); }
 ...
 *>    if (rc == 0)  rc = ykine_move_savedtail  (s_servo + 0, NULL, &yb, NULL, NULL, NULL, NULL);   <* 
 *>    if (rc == 0)  rc = ykine_move_savedtail  (s_servo + 1, NULL, &pb, NULL, NULL, NULL, NULL);   <* 
 *>    if (rc == 0)  rc = ykine_move_savedtail  (s_servo + 2, NULL, &rb, NULL, NULL, NULL, NULL);   <* 
 *>    /+---(reporting)-------------------+/                                                        <* 
 ...
 *>       ykine_body_ypr2xzy    (ye, pe, re, &x, &z, &y, &l);                                                           <* 
...
char   ykine_body_orient       (void) { return ykine_legs_driver (YKINE_OR); }
char   ykine_body_tilt         (void) { return ykine_legs_driver (YKINE_TI); }
