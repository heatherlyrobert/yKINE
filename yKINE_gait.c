 ...
 *>          ykine_move_create (YKINE_MOVE_NOTE , g_servo_info + i, "6_GAIT_BEG"   , myKINE.s_nline, 0.0  , 0.0);   <* 
 *>          break;                                                                                                 <* 
 *>       case  0 :                                                                                                 <* 
 *>          DEBUG_YKINE_SCRP   yLOG_note     ("starting a walking gait");                                          <* 
 *>          ykine_move_create (YKINE_MOVE_NOTE , g_servo_info + i, "WA_GAIT_BEG"  , myKINE.s_nline, 0.0  , 0.0);   <* 
 *>          break;                                                                                                 <* 
 *>       case 12 :                                                                                                 <* 
 *>          DEBUG_YKINE_SCRP   yLOG_note     ("starting a 12 gait");                                               <* 
 *>          ykine_move_create (YKINE_MOVE_NOTE , g_servo_info + i, "12_GAIT_BEG"  , myKINE.s_nline, 0.0  , 0.0);   <* 
 *>          break;                                                                                                 <* 
 *>       case 18 :                                                                                                 <* 
 *>          DEBUG_YKINE_SCRP   yLOG_note     ("starting a 18 gait");                                               <* 
 *>          ykine_move_create (YKINE_MOVE_NOTE , g_servo_info + i, "18_GAIT_BEG"  , myKINE.s_nline, 0.0  , 0.0);   <* 
 *>          break;                                                                                                 <* 
 *>       }                                                                                                         <* 
